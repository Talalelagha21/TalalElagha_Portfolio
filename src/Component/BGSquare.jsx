...
const BGSquare = () => {
    return (
        <motion.div initial={{
                ...
                className="relative flex justify-center items-center mt-40 z-20">
            <div className="absolute border border-[#333333] rounded-full h-[200px] w-[200px] mt-52
                            animate-ping "/>
            <div className="absolute border border-[#333333] rounded-full h-[300px] w-[300px] mt-52 "/>
            <div className="absolute border border-[#333333] rounded-full h-[500px] w-[500px] mt-52 "/>
            <div className="absolute border border-red-400 opacity-20 rounded-full h-[650px] w-[650px] mt-52 animate-pulse "/>
